    ...
    protected PLVideoView createViewInstance(ThemedReactContext reactContext) {
        ...
        mVideoView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            ...
            public void onViewAttachedToWindow(View v) {
                Log.e("mVideoView", "onViewAttachedToWindow1");
                if (mVideoView == null) {
                    return;
                }
                Log.e("mVideoView", "onViewAttachedToWindow2");
                mVideoView.start();
            }
...
//        mVideoView.mute
    ...
    private PLMediaPlayer.OnPreparedListener mOnPreparedListener = new PLMediaPlayer.OnPreparedListener() {
        @Override
        public void onPrepared(PLMediaPlayer plMediaPlayer, int var2) {
